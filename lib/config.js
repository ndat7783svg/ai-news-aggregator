...
// "Repo nổi bật" qua GitHub Search API: repo AI NHIỀU SAO còn hoạt động gần đây (theo các topic).
// Không giới hạn theo ngày TẠO nữa → lấy được cả repo mới hot lẫn repo lớn kinh điển (llama.cpp,
// ComfyUI, LangChain...) miễn là còn được cập nhật (push) gần đây.
export const GITHUB_TRENDING_TOPICS = [
  "llm",
  "ai-agent",
  "generative-ai",
  "machine-learning",
...
export const GITHUB_TRENDING_PUSHED_DAYS = 180; // chỉ xét repo có push trong N ngày gần đây (còn sống)
export const GITHUB_TRENDING_MIN_STARS = 500; // ngưỡng sao tối thiểu để tránh repo nhỏ/nhiễu
export const GITHUB_TRENDING_PER_TOPIC = 15; // số repo lấy mỗi topic (sắp theo sao)
export const GITHUB_TRENDING_MAX = 60; // giới hạn tổng sau khi gộp trùng

// "Repo kinh điển" qua GitHub Search API: repo AI nổi lâu, nhiều sao (>=5000 sao), không giới hạn ngày push.
export const GITHUB_CLASSICS_MIN_STARS = 5000;
export const GITHUB_CLASSICS_PER_TOPIC = 25;
